...
ADD PriceGomlaAlgomla [float] NULL , PriceNesfAlgomla [float] NULL;
...
GO
--ALTER TABLE [dbo].[Category]
--ADD PriceGomlaAlgomla float AFTER PriceGomla;

--GO

--ALTER TABLE [dbo].[Category] ADD PriceGomlaAlgomla [float] AFTER PriceGomla;
