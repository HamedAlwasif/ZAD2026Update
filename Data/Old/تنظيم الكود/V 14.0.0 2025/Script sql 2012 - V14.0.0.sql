...
BEGIN
    CREATE TABLE [dbo].[Bank](
			...
			[Note] [text] NULL,
        CONSTRAINT [PK_Bank] PRIMARY KEY CLUSTERED ([NumHesab] ASC)
...
BEGIN
    CREATE TABLE [dbo].[Barcode_Seting](
        ...
        CONSTRAINT [PK_Barcode_Seting] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[BillingData](
        ...
        CONSTRAINT [PK_بيانات الفاتورة] PRIMARY KEY CLUSTERED ([NumBill] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[BillingData1](
			...
			[Remaining] [float] NULL,
			[State] [varchar](50) NULL,
        CONSTRAINT [PK_BillingData1] PRIMARY KEY CLUSTERED ([NumBill] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[BoxMove](
		...
		[Total] [float] NULL,
		[Note] [text] NULL,
        CONSTRAINT [PK_BoxMove_1] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Car](
			...
			[Model] [char](10) NULL,
			[Price] [float] NULL,
        CONSTRAINT [PK_Car] PRIMARY KEY CLUSTERED ([NumCar] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Category_BestSeller](
        ...
        CONSTRAINT [PK_BestSeller] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryFaction](
			...
			[Faction] [nvarchar](50) NULL,
			[Type] [nvarchar](50) NULL,
        CONSTRAINT [PK_CategoryFaction] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryIncomplete](
        ...
        CONSTRAINT [PK_CategoryIncomplete] PRIMARY KEY CLUSTERED ([Barcode] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryMove](
			...
			[BalanceK] [float] NULL,
			[BalanceT] [float] NULL,
        CONSTRAINT [PK_CategoryMove] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryMove2](
        ...
        CONSTRAINT [PK_CategoryMove2] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryOthers](
        ...
        CONSTRAINT [PK_CategoryOthers] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryPrice](
			...
			[PriceGomlaAlgomla] [float] NULL,
			[PriceNesfAlgomla] [float] NULL,
        CONSTRAINT [PK_CategoryPrice] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategorysMaterials](
			...
			[Price] [float] NULL,
			[Total] [float] NULL,
        CONSTRAINT [PK_CategorysMaterials_1] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategorysMaterialsData](
        ...
        CONSTRAINT [PK_CategorysMaterialsData] PRIMARY KEY CLUSTERED ([NumBill] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategorySN](
        ...
        CONSTRAINT [PK_CategorySN] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[CategoryTotal](
        ...
        CONSTRAINT [PK_CategoryTotal] PRIMARY KEY CLUSTERED ([Date] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Employed](
        ...
        CONSTRAINT [PK_Employed] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Expended1](
			...
			[Report] [text] NULL,
			[Paid] [float] NULL,
        CONSTRAINT [PK_Expended1] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[FristGard](
			...
			[Bank] [float] NULL,
			[adv] [float] NULL,
        CONSTRAINT [PK_FristGard] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Installment](
			...
			[Date] [nvarchar](50) NULL,
			[Paid] [float] NULL,
        CONSTRAINT [PK_Installment] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[InstallmentData](
        ...
        CONSTRAINT [PK_InstallmentData] PRIMARY KEY CLUSTERED ([InstallmentID] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Invalid](
			...
			[Importer] [nvarchar](50) NULL,
        CONSTRAINT [PK_Invalid] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[MaterialsBill](
        ...
        CONSTRAINT [PK_MaterialsBill] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Mortagaat](
        ...
        CONSTRAINT [PK_Mortagaat] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[Movemoney](
			...
			[Sader] [float] NULL,
			[Wared] [float] NULL,
        CONSTRAINT [PK_Movemoney] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[PriceUpdateDate](
			...
			[Gomla] [float] NULL,
			[Kataee] [float] NULL,
        CONSTRAINT [PK_PriceUpdateDate] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[ProjectTotal](
			...
			[Tahselat] [float] NULL,
        CONSTRAINT [PK_ProjectTotal] PRIMARY KEY CLUSTERED ([Date] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[RasMoney](
			...
			[AddBox] [float] NULL,
			[Total] [float] NULL,
        CONSTRAINT [PK_RasMoney] PRIMARY KEY CLUSTERED ([Date] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[SavePass](
        ...
        CONSTRAINT [PK_SavePass] PRIMARY KEY CLUSTERED ([Name] ASC)
    ) ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[SearchCar](
        ...
        CONSTRAINT [PK_SearchCar] PRIMARY KEY CLUSTERED ([ID] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
BEGIN
    CREATE TABLE [dbo].[SheekSave](
			...
			[Note] [text] NULL,
			[State] [nvarchar](50) NULL,
        CONSTRAINT [PK_SheekSave] PRIMARY KEY CLUSTERED ([NumSkeek] ASC)
    ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
END
GO
...
CREATE TABLE [dbo].[SystemProgram](
 [ID] [int] IDENTITY(1,1) NOT NULL,
	...
	[PricesAll] [int] NULL,
 CONSTRAINT [PK_SystemProgram] PRIMARY KEY CLUSTERED ([ID] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[Treasury](
    ...
    [Remaining] [float] NULL,
    [Notice] [text] NULL,
 CONSTRAINT [PK_Treasury] PRIMARY KEY CLUSTERED ([Date] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
GO
...
VALUES (1, N'عميل نقدى', N'عملاء', N'0', N'0', N'المنصورة', 0, 0, NULL, N'فعال', NULL);
...
INSERT INTO [dbo].[SystemProgram] (
    ...
    [TypePrinter], [BarcodeSize], [BarcodeSalesType], [OpenFormOther], [PricesAll]
) VALUES (
