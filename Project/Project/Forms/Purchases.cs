...
string PriceNesfAlgomla = "0";
        ...
        private void comClient_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (rad.Read())
                {
                    ...
                    textClientName.Text = rad["Name"].ToString();
        ...
        public void CountRemaining()
        {
            ...
            try
            {
                sqlCommand1.CommandText = "insert into BoxMove (ID,Date,Move,Name,NumBill,Remaining,Sader,Wared,Total,Note)values ('" + MoveBoxID + "','" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "','" + FormName + "','" + textClientName.Text + "','" + textBillingDataNumBill.Text + "','" + RasedBox + "','" + txtMosadad.Text + "','" + 0 + "','" + 0 + "','" + 0 + "')";
                sqlCommand1.ExecuteNonQuery();
            }
            catch
            {
        ...
        private void AddProduct()
        {
            ...
            try
            {
                sqlCommand1.CommandText = "insert into BillingData1 (NumBill,NumBillBillingData,ClientID,Name,Date,Move,TotalBill,NumberCategory,PreviousBalance,Total,Discount,ReasonDiscount,Adding,ReasonAdd,Paid,Remaining)values ('" + textBillingData1NumBill.Text + "','" + textBillingDataNumBill.Text + "','" + textClintID.Text + "','" + textClientName.Text + "','" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "','" + FormName + "','" + txtTotalBill.Text + "','" + TxtNumCategorey.Text + "','" + txtRemaningOld.Text + "','" + TotalAndRemaninRasedClient + "','" + txtDic.Text + "','" + 0 + "','" + 0 + "','" + 0 + "','" + txtMosadad.Text + "','" + txtRemainingNow.Text + "')";
            ...
            else if (FormName == "جرد أول المدة")
            {
                try
                {
                    sqlCommand1.CommandText = "insert into BillingData (NumBill,ClientID,Name,Type,Date,Move,NamePrint,PreviousBalance,Creditor,TotalBillBuy,DiscountBuy,TotalBill,TotalBillInvalid,Discount,ReasonDiscount,Adding,ReasonAdd,Total,Pay,Paid,Remaining,State,NumberCategory,TotalBillBuyInvalid)values ('" + textBillingDataNumBill.Text + "','" + textClintID.Text + "','" + textClientName.Text + "','" + textBox43.Text + "','" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "','" + FormName + "','" + textUser.Text + "','" + txtRemaningOld.Text + "','" + txtRemaningOld.Text + "','" + txtTotalBill.Text + "','" + txtDic.Text + "','" + 0 + "','" + 0 + "','" + 0 + "','" + 0 + "','" + 0 + "','" + 0 + "','" + TotalAndRemaninRasedClient + "','" + txtMosadad.Text + "','" + 0 + "','" + txtRemainingNow.Text + "','" + label31.Text + "','" + TxtNumCategorey.Text + "','" + 0 + "')";
