...
namespace ZAD_Sales.Forms
{
    public partial class Barcode : Form
    {
        ...
        private void PrintPage50_40(object sender, PrintPageEventArgs ev)
        {
            ...
            //{
            //    e.Graphics.DrawString(combCategoray.Text,
            //        font,
            //        Brushes.Black,
            //        e.PageBounds.Left,
            //        e.PageBounds.Top);
            ...
            //ev.Graphics.DrawString(drawString, drawFont, drawBrush, recAtZero, drawFormat);
            //RectangleF recAtGreaterThantZero = new RectangleF(300, 0, ev.PageBounds.Width, ev.PageBounds.Height);
            //ev.Graphics.DrawString(drawString, drawFont, drawBrush, recAtGreaterThantZero, drawFormat);

            //int f = int.Parse(AppSetting.FontSizeBarcode);
        ...
        private void PrintPage38_25(object sender, PrintPageEventArgs ev)
        {
            if(comTypeFont.Text== "IDAHC39M Code 39 Barcode")
            {
                ...
                ev.Graphics.DrawString(textPricePrint1.Text, new Font("Tahoma", 7), Brushes.Black, 70, 35, new StringFormat()); // سعر المنتج
