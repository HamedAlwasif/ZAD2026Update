        ...
        public static void Print(this LocalReport report, PageSettings pageSettings)
        {
            string deviceInfo =
                $@"<DeviceInfo>
                    ...
                    <MarginTop>{pageSettings.Margins.Top * 0.5}cm</MarginTop>
                    <MarginLeft>{pageSettings.Margins.Left * 0.5}cm</MarginLeft>
                    <MarginRight>{pageSettings.Margins.Right * 0.5}cm</MarginRight>
                    <MarginBottom>{pageSettings.Margins.Bottom * 0.5}cm</MarginBottom>
                </DeviceInfo>";
            Warning[] warnings;
