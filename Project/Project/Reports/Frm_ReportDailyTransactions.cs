...
{
    public partial class Frm_ReportDailyTransactions : Form
    {
        public Frm_ReportDailyTransactions()
        {
            InitializeComponent();
        }

        private void Frm_ReportDailyTransactions_Load(object sender, EventArgs e)
        {
