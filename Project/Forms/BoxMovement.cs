...
namespace ZAD_Sales.Forms
{
    public partial class BoxMovement : Form
    {
        ...
        private void Searching()
        {
            ...
            try
            {
                sqlCommand1.CommandText = "select SUM(Wared) as wared,SUM(Sader) as sader From BoxMove Where Date <'" + dateFrom.Value.ToString("MM/dd/yyyy") + "' ";
            ...
            adap = new SqlDataAdapter("Select ID,Date,Name,NumBill,Move,Wared,Sader From BoxMove Where Date >= '" + dateFrom.Value.ToString("MM/dd/yyyy") + "' and Date <= '" + dateTo.Value.ToString("MM/dd/yyyy") + "'", cn);
            ...
            this.dataGrDetais.Columns[3].HeaderText = "الفاتورة";
            this.dataGrDetais.Columns[4].HeaderText = "البيان";
            this.dataGrDetais.Columns[5].HeaderText = "الوارد";
            this.dataGrDetais.Columns[6].HeaderText = "الصادر";
            dataGrDetais.Columns.Add("col7", "الرصيد");
            //this.dataGrDetais.Columns[7].HeaderText = "ملاحظات";



            this.dataGrDetais.Columns[0].Width = 65;
            this.dataGrDetais.Columns[1].Width = 80;
            this.dataGrDetais.Columns[2].Width = 180;
            this.dataGrDetais.Columns[3].Width = 65;
            this.dataGrDetais.Columns[4].Width = 220;
            this.dataGrDetais.Columns[5].Width = 100;
            this.dataGrDetais.Columns[6].Width = 100;
            this.dataGrDetais.Columns[7].Width = 100;
            ...
            {
                sum341 += Convert.ToDouble(dataGrDetais.Rows[i].Cells[5].Value);
                sum531 += Convert.ToDouble(dataGrDetais.Rows[i].Cells[6].Value);
        ...
        private void BoxMovement_Load(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(boxBalance.ToString("N2"));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow item in dataGrDetais.Rows)
            {
                ...
                dataGrDetais.Rows[i].Cells[7].Value =
                    ((Convert.ToDouble(dataGrDetais.Rows[i].Cells[5].Value) -
                     Convert.ToDouble(dataGrDetais.Rows[i].Cells[6].Value)) + t).ToString();

                //textBox11.Text = dataGrDetais.Rows[i].Cells[6].Value.ToString();
                textBox11.Text = Math.Round(double.Parse(dataGrDetais.Rows[i].Cells[7].Value.ToString()), 2).ToString();
        ...
        private void butPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //-----------------------
                AppSetting.date_From = dateFrom.Text;
                AppSetting.date_To = dateTo.Text;
                ...
                for (int i = 0; i < dataGrDetais.Rows.Count; i++)
                {
                    ...
                    ClassReportBox Box_Move = new ClassReportBox
                    {
                        ...
                        NumBill = dataGrDetais.Rows[i].Cells[3].Value.ToString(),
                        Move = dataGrDetais.Rows[i].Cells[4].Value.ToString(),
                        Wared = Convert.ToDouble(dataGrDetais.Rows[i].Cells[5].Value),
                        Sader = Convert.ToDouble(dataGrDetais.Rows[i].Cells[6].Value),
                        Remaining = Convert.ToDouble(dataGrDetais.Rows[i].Cells[7].Value)
                    };
